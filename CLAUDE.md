...
- `Majik.Console/` — diagnostic CLI. Subcommands: `export-modern-cards` (regenerates the embedded card seed) and `tune-bot-weights` (offline self-play optimizer for `ArchetypeWeights`). Not a gameplay UI.
