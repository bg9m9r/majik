...
**Latest origin/main:** 4a8d76a (… + Tireless Tracker + Chalice of the Void + Wrenn's Resolve + Bonecrusher Giant + Spell Snare + Phantasmal Image); Cabal Ritual added in this PR.
...
| 4 | Manamorphose | low | Cantrip + add-2-mana-any-color; no template wires a mana-pool deposit effect from an instant/sorcery resolve. Cabal Ritual proved out the per-card mana-pool deposit shape; shared template still TBD. |
