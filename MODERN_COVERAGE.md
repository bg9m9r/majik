...
|---|---|---|---|
| ~~1~~ | ~~The One Ring~~ | — | **Implemented.** See named-factory table above. |
...
| ~~4~~ | ~~Hogaak, Arisen Necropolis~~ | — | **Implemented.** See named-factory table above. |
| ~~5~~ | ~~Bridge from Below~~ | — | **Implemented.** See named-factory table above. |
...
| ~~11~~ | ~~Archmage's Charm~~ | — | **Implemented.** See named-factory table above. |
