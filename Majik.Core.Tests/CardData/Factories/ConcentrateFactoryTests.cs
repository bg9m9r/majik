...
/// <summary>
/// Unit tests for <see cref="ConcentrateFactory"/>.
///
/// Card: Concentrate — Sorcery {2}{U}{U} (Mirrodin).
///   "Draw three cards."
///
/// Covers:
///   - Identity (name, Sorcery type, mana cost {2}{U}{U}, owner/controller).
...
/// </summary>
public class ConcentrateFactoryTests
{
    ...
    [Fact]
    public void Concentrate_Identity()
    {
        var c = ConcentrateFactory.Create(_alice);

        c.Name.Should().Be("Concentrate");
    ...
    [Fact]
    public void Concentrate_DispatchesViaNamedCardFactory()
    {
        var c = NamedCardFactory.Create("Concentrate", _alice);
    ...
    public void Resolve_DrawsThreeCardsFromTopOfLibrary()
    {
        ...
        var effects = ConcentrateFactory.BuildResolveEffect(_alice);
