...
public class DarkslickShoresTests
{
    ...
    [Fact]
    public void DarkslickShores_Dispatch_ResolvesViaNamedCardFactory()
    {
        var alice = new Player("Alice", 20);

        var card = NamedCardFactory.Create("Darkslick Shores", alice);
    ...
    [Fact]
    public void DarkslickShores_SingleArgDispatch_DoesNotRegisterReplacement()
    {
        ...
        var alice = new Player("Alice", 20);
        var land = NamedCardFactory.Create("Darkslick Shores", alice);
