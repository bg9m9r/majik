...
public class GraypeltRefugeTests
{
    ...
    {
        var land = GraypeltRefugeFactory.Create(_alice);
    ...
    [Fact]
    public void NamedCardFactory_Dispatches_GraypeltRefuge()
    {
        var card = NamedCardFactory.Create("Graypelt Refuge", _alice);

        card.Should().BeOfType<Land>();
        card.Name.Should().Be("Graypelt Refuge");
    ...
    public void GraypeltRefuge_EtbEffect_GainsExactlyOneLife()
    {
        ...
        var land = GraypeltRefugeFactory.Create(alice);
