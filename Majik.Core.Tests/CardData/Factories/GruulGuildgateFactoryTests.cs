...
public class GruulGuildgateFactoryTests
{
    ...
    [Fact]
    public void GruulGuildgate_Dispatch_ReturnsLandWithGateSubtype()
    {
        var card = NamedCardFactory.Create("Gruul Guildgate", _alice);

        card.Should().BeAssignableTo<Land>();
        card.Name.Should().Be("Gruul Guildgate");
