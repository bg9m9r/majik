...
/// <summary>
/// Tests for <see cref="JundPanoramaFactory"/> (Alara Reborn — the Jund member
...
///   Swamp / Mountain / Forest (CR 205.4a), with the extra generic {1} on the
///   fetch cost (CR 117.5).
/// </summary>
[Trait("Color", "C")]
public class JundPanoramaFactoryTests
{
    ...
    {
        var land = (Land)NamedCardFactory.Create("Jund Panorama", _alice);

        land.Name.Should().Be("Jund Panorama");
    ...
    public void Activation_FetchesBasicMountain_AndBasicForest_AreLegalTargets()
    {
        ...
        basicMountain.IsTapped.Should().BeTrue();
    }
