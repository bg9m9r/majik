...
public class KetriaTriomeFactoryTests
{
    ...
    [Fact]
    public void KetriaTriome_Dispatch_ReturnsLandWithAllThreeSubtypes()
    {
        var card = NamedCardFactory.Create("Ketria Triome", _alice);

        card.Should().BeAssignableTo<Land>();
        card.Name.Should().Be("Ketria Triome");
