...
public class NaturalizeFactoryTests
{
    ...
    [Fact]
    public void NamedCardFactory_DispatchByName_ReturnsNaturalizeShape()
    {
        var dispatched = NamedCardFactory.Create("Naturalize", _alice);

        dispatched.Should().BeOfType<Instant>();
        dispatched.Name.Should().Be("Naturalize");
        dispatched.ManaCost.Should().Be("{1}{G}");
    }
