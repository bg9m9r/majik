...
public class RakdosGuildgateFactoryTests
{
    ...
    [Fact]
    public void RakdosGuildgate_Dispatch_ReturnsLandWithGateSubtype()
    {
        var card = NamedCardFactory.Create("Rakdos Guildgate", _alice);

        card.Should().BeAssignableTo<Land>();
        card.Name.Should().Be("Rakdos Guildgate");
