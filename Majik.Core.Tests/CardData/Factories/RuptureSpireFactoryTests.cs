...
/// <summary>
/// Tests for <see cref="RuptureSpireFactory"/> — Rupture Spire (Conflux).
/// Oracle text (verified against Scryfall):
///   "This land enters tapped.
///    When this land enters, sacrifice it unless you pay {1}.
///    {T}: Add one mana of any color."
///
/// Functionally identical to Transguild Promenade. Covers:
...
/// </summary>
[Trait("Color", "C")]
public class RuptureSpireFactoryTests
{
    private const string CardName = "Rupture Spire";
    ...
    [Fact]
    public void RuptureSpire_IsLand_WithCorrectName()
    {
        var alice = new Player("Alice", 20);

        var land = RuptureSpireFactory.Create(alice);
    ...
    [Fact]
    public void RuptureSpire_OwnerAndControllerAreSet()
    {
        var alice = new Player("Alice", 20);
    ...
    [Fact]
    public void RuptureSpire_IsNotBasic_AndNotLegendary()
    {
        var alice = new Player("Alice", 20);
    ...
    [Fact]
    public void RuptureSpire_HasFiveManaAbilities_OnePerColor()
    {
        var alice = new Player("Alice", 20);
    ...
    [Fact]
    public void RuptureSpire_HasNoColorlessManaAbility()
    {
        var alice = new Player("Alice", 20);
    ...
    public void RuptureSpire_ProducesEachColor(string color)
    {
        var alice = new Player("Alice", 20);
        ...
        ability.Should().NotBeNull($"Rupture Spire can add {{{color}}}");
    }

    [Theory]
    [MemberData(nameof(AllColors))]
    public void RuptureSpire_TapForMana_DoesNotCostLife(string color)
    {
    ...
    [Fact]
    public void RuptureSpire_CannotActivateColoredWhenTapped()
    {
        var alice = new Player("Alice", 20);
        var land = RuptureSpireFactory.Create(alice);
    ...
    [Fact]
    public void RuptureSpire_HasOneEtbTriggeredAbility()
    {
        var alice = new Player("Alice", 20);
    ...
    [Fact]
    public void RuptureSpire_OnResolve_WithMana_PaysAndStays()
    {
        var alice = new Player("Alice", 20);
        var land = RuptureSpireFactory.Create(alice);
    ...
    [Fact]
    public void RuptureSpire_OnResolve_WithoutMana_SacrificesIt()
    {
        var alice = new Player("Alice", 20);
        var land = RuptureSpireFactory.Create(alice);
    ...
    [Fact]
    public void RuptureSpire_DispatchesThroughNamedFactory()
    {
        var alice = new Player("Alice", 20);
