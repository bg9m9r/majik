...
public class TempleOfEnlightenmentTests
{
    ...
    [Fact]
    public void NamedCardFactory_Dispatches_TempleOfEnlightenment()
    {
        var card = NamedCardFactory.Create("Temple of Enlightenment", _alice);

        card.Should().BeOfType<Land>();
        card.Name.Should().Be("Temple of Enlightenment");
