...
/// <summary>
/// Unit tests for <see cref="ThrabenInspectorFactory"/>.
///
/// Thraben Inspector (Shadows over Innistrad, {W}):
...
///
/// Covers:
/// - Identity (Creature — Human Soldier 1/2 at {W}, owner / controller
...
public class ThrabenInspectorFactoryTests
{
    ...
    [Fact]
    public void ThrabenInspector_Identity()
    {
        var c = ThrabenInspectorFactory.Create(_alice);
    ...
    [Fact]
    public void ThrabenInspector_Etb_Investigates_CreatesClueUnderController()
    {
        var c = ThrabenInspectorFactory.Create(_alice);
