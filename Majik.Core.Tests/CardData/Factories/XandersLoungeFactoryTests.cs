...
public class XandersLoungeFactoryTests
{
    ...
    [Fact]
    public void XandersLounge_Dispatch_ReturnsLandWithAllThreeSubtypes()
    {
        var card = NamedCardFactory.Create("Xander's Lounge", _alice);

        card.Should().BeAssignableTo<Land>();
        card.Name.Should().Be("Xander's Lounge");
