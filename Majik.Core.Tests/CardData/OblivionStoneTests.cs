...
public class OblivionStoneTests
{
    ...
    public void SacSelf_OnProdPath_PublishesPermanentSacrificedEvent()
    {
        ...
        // {5},{T},Sac sweep ability publishes PermanentSacrificedEvent
        // (CR 701.16a).
        ...
        var built = NamedCardFactory.Create("Oblivion Stone", _alice, effects);
        ...
        var sac = stone.Abilities.OfType<ActivatedAbility>()
