...
/// <summary>
/// Unit tests for <see cref="RazorvergeThicketFactory"/> — Mirrodin Besieged
/// G/W fastland.
///
...
/// production — CR 614.1c).
/// </summary>
public class RazorvergeThicketTests
{
    ...
    [Fact]
    public void RazorvergeThicket_DispatchedThroughNamedCardFactory()
    {
        var card = NamedCardFactory.Create("Razorverge Thicket", _alice);

        card.Should().BeOfType<Land>();
        card.Name.Should().Be("Razorverge Thicket");
    }
}
