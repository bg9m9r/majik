...
public class SakuraTribeElderTests
{
    ...
    private sealed class EmptyPromptRecordingAgent : global::Majik.Core.Players.Agents.IPlayerAgent
    {
        ...
        public Task<global::Majik.Core.Players.Agents.CombatPlan> DeclareAttackersAsync(global::Majik.Core.Game.GameContext ctx, IReadOnlyList<Permanent> eligibleAttackers, CancellationToken ct = default) => throw new NotImplementedException();
        public Task<global::Majik.Core.Players.Agents.BlockPlan> DeclareBlockersAsync(global::Majik.Core.Game.GameContext ctx, IReadOnlyList<Permanent> attackers, IReadOnlyList<Permanent> eligibleBlockers, CancellationToken ct = default) => throw new NotImplementedException();
