...
/// <summary>
/// Unit tests for <see cref="TaigamsSchemingFactory"/>.
///
/// Taigam's Scheming (Khans of Tarkir, {1}{U}, Sorcery):
...
public class TaigamsSchemingTests : IDisposable
{
    ...
    [Fact]
    public void TaigamsScheming_HasExpectedShape()
    {
        var card = TaigamsSchemingFactory.Create(_alice);

        card.Name.Should().Be("Taigam's Scheming");
    ...
    [Fact]
    public void NamedCardFactory_Dispatches_TaigamsScheming()
    {
        var card = NamedCardFactory.Create("Taigam's Scheming", _alice);
    ...
    [Fact]
    public void TaigamsScheming_Resolve_DefaultSurveil_MillsTopFive()
    {
        ...
        var effect = TaigamsSchemingFactory.BuildResolveEffect(_alice).Single();
        effect.Execute();
    ...
    [Fact]
    public void TaigamsScheming_Resolve_AgentPartition_MillsSomeKeepsRest()
    {
    ...
    [Fact]
    public void TaigamsScheming_Resolve_ShortLibrary_SurveilsWhatExists()
    {
