...
public sealed class MutableFieldTripwireTests
{
    ...
    private static readonly Dictionary<Type, HashSet<string>> Known = new()
    {
        [typeof(Card)] = new HashSet<string>
        {
            ...
            "RuntimeExileCastAllowedCaster",        // COPIED (player ref — will be stale until RelinkReferences; acceptable for sim)
            ...
            "RuntimeGraveyardNonOwnerCastAllowedCaster", // COPIED (player ref — same note as RuntimeExileCastAllowedCaster)
