...
/// <summary>
/// Named-card factory for Akoum Refuge (Zendikar "Refuge" gain-life tapland
/// cycle). Black/red member — same oracle shape as Bloodfell Caves. Oracle
...
/// (CR 119.3), and two single-colour mana abilities {B}/{R} (CR 605.1 —
...
/// declaratively in <c>Majik.Core/CardData/Cards/akoum-refuge.json</c> and
...
{
    public const string Slug = "akoum-refuge";
    ...
    /// <summary>Construct Akoum Refuge with optional replacement-bus wiring so
