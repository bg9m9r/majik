...
/// <c>Gate</c> subtype (CR 205.3m) plus the two mana abilities {W}/{U}
/// (CR 605.1 — mana abilities don't use the stack) — is declared
/// declaratively in <c>Majik.Core/CardData/Cards/azorius-guildgate.json</c>
...
public static class AzoriusGuildgateFactory
{
    ...
    /// <summary>Construct Azorius Guildgate with optional replacement-bus
