...
/// double-faced land "Barkchannel Pathway // Tidechannel Pathway".
///
...
/// <list type="bullet">
///   <item><see cref="BarkchannelPathwayFactory"/> — the FRONT face
///     (Land: "{T}: Add {G}."). It builds the land WITH the full
///     <see cref="Majik.Core.CardData.MDFCs.MdfcState"/> wiring (front =
///     Barkchannel Pathway, back = the land Tidechannel Pathway), starting on
///     the front face.</item>
///   <item><see cref="TidechannelPathwayFactory"/> — the BACK face
///     (Land: "{T}: Add {U}.").</item>
/// </list>
///
/// However, the embedded Modern seed keys this card under its <b>combined</b>
/// name ("Barkchannel Pathway // Tidechannel Pathway") — that is the row whose
...
/// </summary>
[CardName("Barkchannel Pathway // Tidechannel Pathway")]
public static class BarkchannelPathwayCombinedNameFactory
{
    public const string CombinedName =
        "Barkchannel Pathway // Tidechannel Pathway";

    /// <summary>
    /// Build the front face (Barkchannel Pathway — Land) with its full
    /// <see cref="Majik.Core.CardData.MDFCs.MdfcState"/> wiring (front =
    /// Barkchannel Pathway, back = Tidechannel Pathway). This is the overload
    /// <see cref="NamedCardFactory"/> dispatches the combined printed name to.
    /// </summary>
    public static Land Create(Player owner) =>
        BarkchannelPathwayFactory.Create(owner);
}
