...
/// <summary>
/// Named-card factory for Bloodstained Mire (Onslaught / reprints).
///
/// Land. Oracle text:
///   "{T}, Pay 1 life, Sacrifice Bloodstained Mire: Search your library for a
///    Swamp or Mountain card, put it onto the battlefield, then shuffle."
///
/// ## Implementation (v1)
/// Same shape as <see cref="PollutedDeltaFactory"/>. Fetches
/// <see cref="CardSubtype.Swamp"/> or <see cref="CardSubtype.Mountain"/>.
///
/// ## Deferred (v1 gaps)
...
public static class BloodstainedMireFactory
{
    public const string CardName = "Bloodstained Mire";

    /// <summary>
    /// Construct Bloodstained Mire owned and controlled by <paramref name="owner"/>.
    /// </summary>
    public static Land Create(Player owner)
    {
        ...
        var fetchAbility = new ActivatedAbility(
            ...
            {
                new Effect(
                    "Bloodstained Mire: search library for Swamp or Mountain, put onto battlefield",
                    () => FetchLandEffect(owner, land, CardSubtype.Swamp, CardSubtype.Mountain)),
            });
