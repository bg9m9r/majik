...
/// <summary>
/// Named-card factory for Blooming Marsh (Kaladesh) — the B/G member of the
/// "fast land" cycle. Oracle (verified against Scryfall):
/// <code>
...
/// <c>Majik.Core/CardData/Cards/blooming-marsh.json</c> and materialized via
...
/// enters untapped iff the controller controls at most two OTHER lands
/// ("other" excludes this fast land via reference equality; "you control"
...
public static class BloomingMarshFactory
{
    ...
    /// <summary>
    /// Construct Blooming Marsh owned and controlled by
    ...
    /// <summary>
    /// Construct Blooming Marsh with an optional <see cref="ReplacementBus"/>
