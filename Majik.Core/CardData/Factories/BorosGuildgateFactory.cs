...
/// <c>Gate</c> subtype (CR 205.3m) plus the two mana abilities {R}/{W}
/// (CR 605.1 — mana abilities don't use the stack) — is declared
/// declaratively in <c>Majik.Core/CardData/Cards/boros-guildgate.json</c>
...
public static class BorosGuildgateFactory
{
    ...
    /// <summary>Construct Boros Guildgate with optional replacement-bus
