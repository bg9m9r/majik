...
/// <summary>
/// Named-card factory for Boros Signet (Guildpact / Ravnica signet cycle).
///
...
/// "spend {1}, gain {R}{W}" (a +1 mana, fixing-into-colour swap).
///
/// Thin wrapper that loads
/// <c>Majik.Core/CardData/Cards/boros-signet.json</c> and builds through
...
///
/// CR 605.1a — "Add {R}{W}" produces both coloured pips together in a
/// single activation (modelled as one <see cref="Majik.Core.Abilities.ManaAbility"/>
/// emitting {R}{W}), distinct from the talisman cycle's "Add {A} or {B}"
/// modal split.
/// </summary>
...
public static class BorosSignetFactory
{
    ...
    /// <summary>Construct Boros Signet owned and controlled by
