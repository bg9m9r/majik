...
/// <summary>
/// Named-card factory for Botanical Sanctum (Kaladesh) — the G/U member of
...
/// <c>Majik.Core/CardData/Cards/botanical-sanctum.json</c> and materialized
...
public static class BotanicalSanctumFactory
{
    ...
    /// <summary>
    /// Construct Botanical Sanctum owned and controlled by
    ...
    /// <summary>
    /// Construct Botanical Sanctum with an optional <see cref="ReplacementBus"/>
