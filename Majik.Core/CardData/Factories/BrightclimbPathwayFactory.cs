...
///   "{T}: Add {W}."
///
/// Back face — <see cref="GrimclimbPathwayFactory"/> (Land — "{T}: Add {B}.").
///
...
/// <see cref="ClearwaterPathwayFactory"/> / <see cref="MurkwaterPathwayFactory"/>,
/// but here the colors are {W} (front) / {B} (back):
/// <list type="bullet">
///   <item>Playing the front face → <see cref="NamedCardFactory"/> resolves
///     <c>"Brightclimb Pathway"</c> → this factory → a <see cref="Land"/>
///     with a single {T}: Add {W} mana ability.</item>
///   <item>Playing the back face → <see cref="NamedCardFactory"/> resolves
///     <c>"Grimclimb Pathway"</c> → <see cref="GrimclimbPathwayFactory"/>
...
///   <c>Majik.Core/CardData/Cards/brightclimb-pathway.json</c> and
...
/// - <see cref="MdfcState"/> attached (front = "Brightclimb Pathway", back =
///   "Grimclimb Pathway"); starts on the front face.
///
...
/// </summary>
[CardName("Brightclimb Pathway")]
public static class BrightclimbPathwayFactory
{
    public const string CardName = "Brightclimb Pathway";
    public const string BackName = "Grimclimb Pathway";

    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource("brightclimb-pathway");

    /// <summary>Construct Brightclimb Pathway (front face) owned and
    ...
    public static Land Create(Player owner)
    {
        ...
        // back-face name (Grimclimb Pathway) is observable from the
