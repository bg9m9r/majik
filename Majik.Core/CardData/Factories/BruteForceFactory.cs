...
/// <summary>
/// Named-card factory for Brute Force (Odyssey, {R}).
///
/// Instant. Oracle text:
...
///
/// Mirrors <see cref="GiantGrowthFactory"/> exactly — identical effect
/// at {R} (red) instead of {G} (green).
/// </summary>
[CardName("Brute Force")]
public static class BruteForceFactory
{
    public const string CardName = "Brute Force";
