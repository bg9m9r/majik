...
/// <summary>
/// Named-card factory for Bull Rush (Portal, {R}).
///
/// Instant. Oracle text:
...
///   register a <see cref="PumpUntilEndOfTurnEffect"/>(+2, +0) on the
...
///
/// Mirrors <see cref="InfuriateFactory"/> with asymmetric +2/+0 pump
/// at {R} instead of +3/+2 at {R}.
/// </summary>
[CardName("Bull Rush")]
public static class BullRushFactory
{
    public const string CardName = "Bull Rush";
    ...
    /// <summary>
    /// Build the "target creature gets +2/+0 until end of turn"
    ...
    /// valid, registers a <see cref="PumpUntilEndOfTurnEffect"/>(+2, +0)
    ...
    public static SpellDefinition BuildDefinition() =>
        new(
            ...
            EffectFactory: p =>
            {
                ...
                {
                    new Effect(
                        "Bull Rush — target creature gets +2/+0 until end of turn",
                        () => Resolve(raw)),
                };
            });
