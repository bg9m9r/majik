...
/// <summary>
/// Named-card factory for Concealed Courtyard (Kaladesh) — the W/B member of
/// the "fast land" cycle. Oracle (verified against Scryfall):
/// <code>
...
/// <c>Majik.Core/CardData/Cards/concealed-courtyard.json</c> and materialized
/// via <see cref="CardDefinitionFactory"/>, the same JSON-driven posture as
/// <see cref="SpirebluffCanalFactory"/>.
/// </para>
///
/// <para>
...
/// isolation (same shape as <see cref="SpirebluffCanalFactory"/>):
...
public static class ConcealedCourtyardFactory
{
    ...
    /// <summary>
    /// Construct Concealed Courtyard owned and controlled by
    ...
    /// <summary>
    /// Construct Concealed Courtyard with an optional <see cref="ReplacementBus"/>
