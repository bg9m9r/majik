...
/// <summary>
/// Named-card factory for Copperline Gorge (Innistrad) — the R/G member of the
...
/// <c>Majik.Core/CardData/Cards/copperline-gorge.json</c> and materialized
...
public static class CopperlineGorgeFactory
{
    ...
    /// <summary>
    /// Construct Copperline Gorge owned and controlled by
    ...
    /// <summary>
    /// Construct Copperline Gorge with an optional <see cref="ReplacementBus"/>
