...
/// <summary>
/// Named-card factory for Darkmoss Bridge (Modern Horizons 3 — the BG member
/// of the artifact "Bridge" tapland cycle, the direct sibling of
/// <see cref="DrossforgeBridgeFactory"/> (BR) and
/// <see cref="SlagwoodsBridgeFactory"/> (RG)).
///
...
/// - <b>{T}: Add {B} or {G}</b> (CR 605.1 — mana abilities don't use the
///   stack) — two vanilla <see cref="ManaAbility"/> instances, one per
///   produced colour.
/// </summary>
[CardName("Darkmoss Bridge")]
public static class DarkmossBridgeFactory
{
    public const string CardName = "Darkmoss Bridge";

    /// <summary>
    /// Construct Darkmoss Bridge owned and controlled by
    ...
    /// <summary>
    /// Construct Darkmoss Bridge with an optional <see cref="ReplacementBus"/>.
    /// </summary>
    ...
    public static Land Create(Player owner, ReplacementBus? replacements)
    {
        ...
        // CR 301.1 / 305.1 — Darkmoss Bridge is an Artifact Land. The base
        ...
        // ----------------------------------------------------------------
        // {T}: Add {B} or {G}. CR 605.1 — two mana abilities (no stack),
