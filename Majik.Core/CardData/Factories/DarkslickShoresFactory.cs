...
/// <summary>
/// Named-card factory for Darkslick Shores (Scars of Mirrodin) — the U/B
...
/// <c>Majik.Core/CardData/Cards/darkslick-shores.json</c> and materialized
...
public static class DarkslickShoresFactory
{
    ...
    /// <summary>
    /// Construct Darkslick Shores owned and controlled by
    ...
    /// <summary>
    /// Construct Darkslick Shores with an optional <see cref="ReplacementBus"/>
