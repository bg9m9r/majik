...
/// <summary>
/// Named-card factory for Deathcap Glade (Innistrad: Midnight Hunt) — the
/// B/G member of the "slow land" cycle. Oracle (verified against Scryfall):
/// <code>
...
/// printed subtype) plus the two mana abilities {B}/{G} (CR 605.1 — mana
/// abilities don't use the stack) — is declared declaratively in
/// <c>Majik.Core/CardData/Cards/deathcap-glade.json</c> and materialized via
...
/// the slow-land ETB condition — the INVERSE threshold direction of the fast
/// lands ("two or fewer"). On the production load path it is wired
...
public static class DeathcapGladeFactory
{
    ...
    /// <summary>
    /// Construct Deathcap Glade owned and controlled by
    ...
    /// <summary>
    /// Construct Deathcap Glade with an optional <see cref="ReplacementBus"/>
    ...
    public static Land Create(Player owner, ReplacementBus? replacements)
    {
        ...
        // on the production load path ("more" ⇒ >= threshold).
        // ----------------------------------------------------------------
