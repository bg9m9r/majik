...
/// <summary>
/// Named-card factory for Dismal Backwater (Khans of Tarkir "life-gain dual
/// land", a.k.a. the gain-land cycle). Blue/black member — sibling of the
...
/// {U}/{B} (CR 605.1 — mana abilities don't use the stack).
/// </para>
///
/// <para>
...
/// declaratively in <c>Majik.Core/CardData/Cards/dismal-backwater.json</c> and
...
{
    public const string Slug = "dismal-backwater";
    ...
    /// <summary>Construct Dismal Backwater with optional replacement-bus
