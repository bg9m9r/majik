...
public static class DivestFactory
{
    ...
    /// <summary>
    /// Build the reveal → pick (artifact or creature) → discard
        ...
        IEventBus? eventBus)
    {
        ...
        return new SpellDefinition(
            ...
            EffectFactory: chosen =>
            {
                ...
                return new IEffect[]
                {
                    new Effect("Divest: reveal → caster picks artifact or creature → discard", () =>
                    {
                        ...
                        // CR 700.2 — "You choose an artifact or creature card."
                        ...
                        if (legal.Count > 0)
                        {
                            if (agent != null)
                            {
                                ...
                                if (pick == null
                                    ...
                                    || (!pick.HasType(CardType.Artifact) && !pick.HasType(CardType.Creature))
