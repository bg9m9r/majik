...
/// <summary>
/// Named-card factory for Dragon Fodder ({1}{R}).
///
/// Sorcery. Oracle text:
...
public static class DragonFodderFactory
{
    public const string CardName = "Dragon Fodder";
    ...
    /// <summary>
    /// Construct Dragon Fodder as a Sorcery owned by <paramref name="owner"/>.
    ...
    /// <summary>
    /// Build the <see cref="SpellDefinition"/> for Dragon Fodder. No modes,
