...
/// <summary>
/// Named-card factory for Drossforge Bridge (Modern Horizons 3 — the BR member
/// of the artifact "Bridge" tapland cycle, the direct sibling of
/// <see cref="MistvaultBridgeFactory"/> (UB) and
...
/// - <b>{T}: Add {B} or {R}</b> (CR 605.1 — mana abilities don't use the
///   stack) — two vanilla <see cref="ManaAbility"/> instances, one per
///   produced colour.
/// </summary>
[CardName("Drossforge Bridge")]
public static class DrossforgeBridgeFactory
{
    public const string CardName = "Drossforge Bridge";

    /// <summary>
    /// Construct Drossforge Bridge owned and controlled by
    ...
    /// <summary>
    /// Construct Drossforge Bridge with an optional <see cref="ReplacementBus"/>.
    /// </summary>
    ...
    public static Land Create(Player owner, ReplacementBus? replacements)
    {
        ...
        // CR 301.1 / 305.1 — Drossforge Bridge is an Artifact Land. The base
