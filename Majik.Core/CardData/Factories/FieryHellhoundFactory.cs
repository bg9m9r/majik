...
public static class FieryHellhoundFactory
{
    ...
    public static Creature Create(Player owner)
    {
        ...
        // incremental-audit-tail): "This creature" is read off the live
        ...
        // BEARER gets +1/+0, never the exiled Fiery Hellhound.
        // ----------------------------------------------------------------
        var pumpEffect = new Effect(
            $"{CardName}: +1/+0 until end of turn ({{R}} firebreathing)",
            ctx =>
            {
                // "This creature" = the live re-homed source, falling back to
