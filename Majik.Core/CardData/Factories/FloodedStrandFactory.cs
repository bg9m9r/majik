...
/// <summary>
/// Named-card factory for Flooded Strand (Onslaught / Modern Horizons / reprints).
///
/// Land. Oracle text:
///   "{T}, Pay 1 life, Sacrifice Flooded Strand: Search your library for
///    a Plains or Island card and put it onto the battlefield. Then shuffle
///    your library."
///
/// ## Implemented (v1)
...
///   Plains or Island, put onto the battlefield untapped.
...
public static class FloodedStrandFactory
{
    ...
    public static Land Create(Player owner)
    {
        ...
        var fetchEffect = new Effect(
            $"{CardName}: search library for Plains or Island, put onto battlefield",
            () =>
            {
