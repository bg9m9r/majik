...
/// <summary>
/// Named-card factory for Foot Headquarters — a White/Black "gain land" in the
/// Zendikar "Refuge" tapland shape. Oracle text (verified against Scryfall):
...
/// (CR 119.3), and two single-colour mana abilities {W}/{B} (CR 605.1 —
/// mana abilities don't use the stack). Identical oracle shape to
...
/// declaratively in <c>Majik.Core/CardData/Cards/foot-headquarters.json</c>
...
/// </para>
/// </summary>
[CardName("Foot Headquarters")]
public static class FootHeadquartersFactory
{
    public const string Slug = "foot-headquarters";

    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource(Slug);

    /// <summary>Construct Foot Headquarters owned and controlled by
    ...
    /// <summary>Construct Foot Headquarters with optional replacement-bus wiring
