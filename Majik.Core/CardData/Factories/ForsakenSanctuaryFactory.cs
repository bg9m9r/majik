...
/// <summary>
/// Named-card factory for Forsaken Sanctuary (common tapped-dual cycle, the
/// white/black member). Oracle text (verified against Scryfall):
///   "This land enters tapped.
///    {T}: Add {W} or {B}."
///
/// <para>
/// Same oracle shape as <see cref="HighlandLakeFactory"/> / <see cref="ShivanOasisFactory"/>
/// — a plain tapped dual with two single-colour mana abilities and no Gate
/// subtype or lifegain — only the produced colours differ ({W}/{B} here). The
/// two mana abilities {W}/{B} (CR 605.1 — mana abilities don't use the stack)
/// plus the Land shell are declared declaratively in
/// <c>Majik.Core/CardData/Cards/forsaken-sanctuary.json</c> and materialized
...
/// </para>
/// </summary>
[CardName("Forsaken Sanctuary")]
public static class ForsakenSanctuaryFactory
{
    public const string Slug = "forsaken-sanctuary";

    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource(Slug);

    /// <summary>Construct Forsaken Sanctuary owned and controlled by
    ...
    /// <summary>Construct Forsaken Sanctuary with optional replacement-bus
