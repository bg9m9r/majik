...
/// <summary>
/// Named-card factory for Goldmire Bridge (March of the Machine: The
/// Aftermath — the WB member of the artifact "Bridge" tapland cycle, the
/// direct sibling of <see cref="MistvaultBridgeFactory"/> (UB) and
/// <see cref="RazortideBridgeFactory"/> (WU)).
///
...
/// </code>
///
/// Combines the same two shipped analogues as its cycle siblings:
/// <list type="bullet">
...
///   skips registration, mirroring <see cref="MistvaultBridgeFactory"/>. On
...
/// - <b>{T}: Add {W} or {B}</b> (CR 605.1 — mana abilities don't use the
///   stack) — two vanilla <see cref="ManaAbility"/> instances, one per
///   produced colour.
/// </summary>
[CardName("Goldmire Bridge")]
public static class GoldmireBridgeFactory
{
    public const string CardName = "Goldmire Bridge";

    /// <summary>
    /// Construct Goldmire Bridge owned and controlled by
    ...
    /// <summary>
    /// Construct Goldmire Bridge with an optional <see cref="ReplacementBus"/>.
    /// </summary>
    ...
    public static Land Create(Player owner, ReplacementBus? replacements)
    {
        ...
        // CR 301.1 / 305.1 — Goldmire Bridge is an Artifact Land. The base
        ...
        // posture as MistvaultBridgeFactory.
        // ----------------------------------------------------------------
        ...
        // ----------------------------------------------------------------
        // {T}: Add {W} or {B}. CR 605.1 — two mana abilities (no stack),
