...
/// <summary>
/// Named-card factory for Graypelt Refuge (Zendikar "Refuge" life-gain dual
/// land, a.k.a. the gain-land cycle). Green/white member — same produced
/// colours as the Khans cycle-mate Blossoming Sands. Oracle text (verified
/// against Scryfall):
...
/// declaratively in <c>Majik.Core/CardData/Cards/graypelt-refuge.json</c> and
...
{
    public const string Slug = "graypelt-refuge";
    ...
    /// <summary>Construct Graypelt Refuge with optional replacement-bus
