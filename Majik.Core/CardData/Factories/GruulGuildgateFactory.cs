...
/// <summary>
/// Named-card factory for Gruul Guildgate (Gatecrash / reprints). Member of the
/// Guildgate cycle. Oracle text:
///
/// <code>
...
/// subtype (CR 205.3m) plus the two mana abilities {R}/{G} (CR 605.1 — mana
/// abilities don't use the stack) — is declared declaratively in
/// <c>Majik.Core/CardData/Cards/gruul-guildgate.json</c> and materialized
/// via <see cref="CardDefinitionFactory"/>, the same posture as the
/// Boros/Selesnya/Simic Guildgate factories.
/// </para>
///
/// <para>
