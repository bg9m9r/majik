...
/// <summary>
/// Named-card factory for Haunted Ridge (Innistrad: Midnight Hunt) — the B/R
...
/// <c>Majik.Core/CardData/Cards/haunted-ridge.json</c> and materialized via
...
public static class HauntedRidgeFactory
{
    ...
    /// <summary>
    /// Construct Haunted Ridge owned and controlled by
    ...
    /// <summary>
    /// Construct Haunted Ridge with an optional <see cref="ReplacementBus"/>
