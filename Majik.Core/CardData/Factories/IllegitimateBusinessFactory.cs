...
/// <summary>
/// Named-card factory for Illegitimate Business (Outlaws of Thunder Junction
/// B/G gain-life tapland). Oracle text (verified against Scryfall):
///   "This land enters tapped.
///    When this land enters, you gain 1 life.
///    {T}: Add {B} or {G}."
///
/// <para>
/// Standard gain-land shape — same as <see cref="AkoumRefugeFactory"/>, only
/// the produced colours differ ({B}/{G} here): an unconditional enters-tapped
/// restriction (CR 614.1c), an ETB self-trigger that gains the controller 1
/// life (CR 119.3), and two single-colour mana abilities {B}/{G} (CR 605.1 —
...
/// declaratively in <c>Majik.Core/CardData/Cards/illegitimate-business.json</c>
...
/// </para>
/// </summary>
[CardName("Illegitimate Business")]
public static class IllegitimateBusinessFactory
{
    public const string Slug = "illegitimate-business";

    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource(Slug);

    /// <summary>Construct Illegitimate Business owned and controlled by
    ...
    /// <summary>Construct Illegitimate Business with optional replacement-bus
