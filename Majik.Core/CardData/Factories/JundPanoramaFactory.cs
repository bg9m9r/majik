...
/// <summary>
/// Jund Panorama — Alara Reborn / Conflux-era "Panorama" land. The Jund
/// (BRG) member of the five-card paid-fetch "Panorama" cycle.
///
/// Oracle (verified against Scryfall 2026-06-02):
///   <c>{T}: Add {C}.</c>
///   <c>{1}, {T}, Sacrifice this land: Search your library for a basic Swamp,
...
/// subtypes swapped to Swamp / Mountain / Forest (Jund's BRG colour identity)
/// rather than the Bant Forest / Plains / Island trio.
///
...
/// - <b>{1}, {T}, Sacrifice this land: tutor a basic Swamp/Mountain/Forest onto
...
public static class JundPanoramaFactory
{
    ...
    public static Land Create(Player owner)
    {
        ...
        // {1}, {T}, Sacrifice this land: search for a basic Swamp/Mountain/Forest,
    ...
    private static async ValueTask TutorBasicSwampMountainForestToBattlefieldTappedAsync(Player player, ResolutionContext ctx)
    {
        ...
        // CR 701.20a — shuffle whether or not a card was found.
        LibraryShuffle.ShuffleLibrary(player, "jund-panorama");
    }
}
