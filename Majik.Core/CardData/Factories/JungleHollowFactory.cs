...
/// <summary>
/// Named-card factory for Jungle Hollow (Khans of Tarkir B/G "gain land").
...
/// (CR 119.3), and two single-colour mana abilities {B}/{G} (CR 605.1 —
/// mana abilities don't use the stack). Same oracle shape as the rest of the
/// Tarkir gainland cycle (e.g. <see cref="BloodfellCavesFactory"/>) — only the
/// colours / printing differ.
/// </para>
///
/// <para>
...
/// declaratively in <c>Majik.Core/CardData/Cards/jungle-hollow.json</c> and
...
{
    public const string Slug = "jungle-hollow";
    ...
    /// <summary>Construct Jungle Hollow with optional replacement-bus wiring so
