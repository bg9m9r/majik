...
/// <summary>
/// Named-card factory for Kazandu Refuge (Zendikar "Refuge" gain-life tapland
/// cycle). Red/green member — same oracle shape as Rugged Highlands. Oracle
...
/// (CR 119.3), and two single-colour mana abilities {R}/{G} (CR 605.1 —
...
/// declaratively in <c>Majik.Core/CardData/Cards/kazandu-refuge.json</c> and
...
{
    public const string Slug = "kazandu-refuge";
    ...
    /// <summary>Construct Kazandu Refuge with optional replacement-bus wiring so
