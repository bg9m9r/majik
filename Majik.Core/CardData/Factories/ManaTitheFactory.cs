...
/// <summary>
/// Named-card factory for Mana Tithe (Planar Chaos, {W}).
///
/// Instant. Oracle text:
///   "Counter target spell unless its controller pays {1}."
///
/// ## Implemented (v1)
/// - Instant shape, mana cost {W}, white — the white "Force Spike".
/// - <b>Counter target spell unless its controller pays {1}</b> — identical
///   "auto-pay-if-able" posture as <see cref="QuenchFactory"/> /
///   <see cref="ManaLeakFactory"/>: at resolution, if the target spell's
///   controller can pay {1} it is spent automatically and the counter no-ops
///   (CR 118.4 — "unless" cost); otherwise the spell is countered via
///   <see cref="OracleSpellBinder.RemoveFromStack"/> and goes to the
///   graveyard (CR 701.5).
///
/// ## Deferred
...
/// </summary>
[CardName("Mana Tithe")]
public static class ManaTitheFactory
{
    public const string CardName = "Mana Tithe";
        ...
        Majik.Core.Stack.Stack? stack)
    {
        ...
        return new SpellDefinition(
            ...
            EffectFactory: p =>
            {
                ...
                return new IEffect[]
                {
                    new Effect("Mana Tithe — counter target spell unless its controller pays {1}", () =>
                    {
