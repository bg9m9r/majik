...
public static class MoggFanaticFactory
{
    ...
    /// <summary>
    /// Construct Mogg Fanatic. When <paramref name="eventBus"/> is supplied the
    ...
    public static Creature Create(Player owner, IEventBus? eventBus)
    {
        ...
        var pingEffect = new Effect(
            ...
            () =>
            {
                ...
                {
                    // CR 701.16a — route through the bus-aware Fx.Sacrifice
                    // overload when a bus is wired so PermanentSacrificedEvent
