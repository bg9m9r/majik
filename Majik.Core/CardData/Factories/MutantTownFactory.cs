...
/// <summary>
/// Named-card factory for Mutant Town (green/blue gain-life tapland — same
/// oracle shape as the Zendikar "Refuge" cycle). Oracle text (verified
/// against Scryfall):
...
/// (CR 119.3), and two single-colour mana abilities {G}/{U} (CR 605.1 —
...
/// declaratively in <c>Majik.Core/CardData/Cards/mutant-town.json</c> and
...
/// </para>
/// </summary>
[CardName("Mutant Town")]
public static class MutantTownFactory
{
    public const string Slug = "mutant-town";

    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource(Slug);

    /// <summary>Construct Mutant Town owned and controlled by
    ...
    /// <summary>Construct Mutant Town with optional replacement-bus wiring so
