...
/// ability-side <c>destroy_target</c> verb Shatter / Boseiju use. The "artifact
/// or enchantment" restriction is enforced both at gather time and (CR 608.2b) at
/// resolution via the shared <see cref="TargetFilters"/> predicate, so an
/// off-type raw target fizzles cleanly. Indestructible (CR 702.12) / regeneration
