...
/// <summary>
/// Named-card factory for Opulent Palace (Khans of Tarkir — the "Sultai"
/// wedge tapland cycle). Oracle text:
///   "This land enters tapped.
///    {T}: Add {B}, {G}, or {U}."
///
/// <para>
/// Mirrors the guildgate / triome land posture (e.g.
/// <see cref="IzzetGuildgateFactory"/>, <see cref="ZagothTriomeFactory"/>):
/// the Land shell — the three mana abilities {B}/{G}/{U} (CR 605.1 — mana
/// abilities don't use the stack) — is declared declaratively in
/// <c>Majik.Core/CardData/Cards/opulent-palace.json</c> and materialized via
/// <see cref="CardDefinitionFactory"/>. Unlike the Sultai triome (Zagoth)
/// this card carries no basic land subtypes and has no cycling clause; it is
/// a plain enters-tapped tri-land.
/// </para>
///
/// <para>
...
/// </para>
/// </summary>
[CardName("Opulent Palace")]
public static class OpulentPalaceFactory
{
    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource("opulent-palace");

    /// <summary>Construct Opulent Palace owned and controlled by
    ...
    /// <summary>Construct Opulent Palace with optional replacement-bus
