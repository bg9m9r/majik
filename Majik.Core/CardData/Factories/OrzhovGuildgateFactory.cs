...
/// <summary>
/// Named-card factory for Orzhov Guildgate (Return to Ravnica / Guilds of
...
/// <c>Gate</c> subtype (CR 205.3m / CR 702 gate cards carry the Gate land
/// subtype) plus the two mana abilities {W}/{B} (CR 605.1 — mana abilities
/// don't use the stack) — is declared declaratively in
/// <c>Majik.Core/CardData/Cards/orzhov-guildgate.json</c> and materialized
/// via <see cref="CardDefinitionFactory"/>. Like the rest of the guildgate
/// cycle there is no cycling clause.
/// </para>
///
/// <para>
...
public static class OrzhovGuildgateFactory
{
    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource("orzhov-guildgate");

    /// <summary>Construct Orzhov Guildgate owned and controlled by
    ...
    /// <summary>Construct Orzhov Guildgate with optional replacement-bus
