...
/// <summary>
/// Named-card factory for Overgrown Farmland (Innistrad: Midnight Hunt
/// slowland cycle).
///
/// G/W slowland. Oracle text:
///   "This land enters tapped unless you control two or more other lands.
///    {T}: Add {G} or {W}."
///
/// Thin wrapper that loads
/// <c>Majik.Core/CardData/Cards/overgrown-farmland.json</c> and lets
...
/// Deserted Beach, Stormcarved Coast, Deathcap Glade, Dreamroot Cascade,
/// Haunted Ridge, Rockfall Vale, Shipwreck Marsh, Sundown Pass.
///
...
public static class OvergrownFarmlandFactory
{
    ...
    /// <summary>
    /// Construct Overgrown Farmland owned and controlled by <paramref name="owner"/>.
    /// </summary>
