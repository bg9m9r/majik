...
/// <summary>
/// Named-card factory for Pearl Medallion (Tempest, {2}).
///
...
///   spell whose colours include white — like the rest of the Medallion
///   cycle, the discount applies to EVERY spell of its colour, so there is
///   no card-type gate.
...
///   engine.
/// </summary>
[CardName("Pearl Medallion")]
public static class PearlMedallionFactory
{
    public const string CardName = "Pearl Medallion";
    public const string PrintedManaCost = "{2}";

    /// <summary>
    /// Construct Pearl Medallion owned and controlled by
    /// <paramref name="owner"/>, with the white-spell cost-reduction rider
    ...
    public static Artifact Create(Player owner)
    {
        ...
        // CR 117.7 — "White spells you cast cost {1} less to cast." Any white
        ...
        card.AddAbility(new SpellCostReductionAbility(
            predicate: c => CardColors.GetColors(c).Contains(ManaColor.White),
            reduction: (_, _) => 1,
