...
/// <summary>
/// Named-card factory for Quick Study ({2}{U}).
///
/// Instant. Oracle text:
///   "Draw two cards."
///
...
/// </summary>
[CardName("Quick Study")]
public static class QuickStudyFactory
{
    public const string CardName = "Quick Study";
    public const string PrintedManaCost = "{2}{U}";
    public const int DrawAmount = 2;

    /// <summary>
    /// Construct Quick Study as an Instant owned by <paramref name="owner"/>.
    ...
    /// <summary>
    /// Build the <see cref="SpellDefinition"/> for Quick Study. No modes,
