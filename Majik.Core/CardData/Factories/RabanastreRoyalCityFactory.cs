...
/// <summary>
/// Named-card factory for Rabanastre, Royal City (Final Fantasy). Oracle text:
///   "This land enters tapped.
///    {T}: Add {R} or {W}."
///
/// <para>
/// An R/W dual tapland in the "Town" cycle — mechanically identical to
/// <see cref="BaronAirshipKingdomFactory"/> (same enters-tapped posture, same
/// printed <c>Town</c> subtype, CR 205.3m), differing only in produced colours
/// (R/W vs U/R). The Land shell — the <c>Town</c> subtype plus the two mana
/// abilities {R}/{W} (CR 605.1 — mana abilities don't use the stack) — is
/// declared declaratively in
/// <c>Majik.Core/CardData/Cards/rabanastre-royal-city.json</c> and materialized
...
/// </para>
/// </summary>
[CardName("Rabanastre, Royal City")]
public static class RabanastreRoyalCityFactory
{
    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource("rabanastre-royal-city");

    /// <summary>Construct Rabanastre, Royal City owned and controlled by
    ...
    /// <summary>Construct Rabanastre, Royal City with optional replacement-bus
