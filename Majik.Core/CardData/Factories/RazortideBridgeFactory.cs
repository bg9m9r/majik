...
/// <summary>
/// Named-card factory for Razortide Bridge (March of the Machine: The
/// Aftermath — the WU member of the artifact "Bridge" tapland cycle).
///
/// Type line: <c>Artifact Land</c>. Oracle text:
/// <code>
...
/// </code>
///
/// Combines two shipped analogues:
/// <list type="bullet">
...
///   skips registration, mirroring <see cref="SavaiTriomeFactory"/>. On the
///   production load path the tapped clause is also matched by
///   <see cref="Majik.Core.CardData.EntersTappedBinder"/> off the oracle text.
/// - <b>{T}: Add {W} or {U}</b> (CR 605.1 — mana abilities don't use the
///   stack) — two vanilla <see cref="ManaAbility"/> instances, one per
///   produced colour.
/// </summary>
[CardName("Razortide Bridge")]
public static class RazortideBridgeFactory
{
    public const string CardName = "Razortide Bridge";

    /// <summary>
    /// Construct Razortide Bridge owned and controlled by
    ...
    /// <summary>
    /// Construct Razortide Bridge with an optional <see cref="ReplacementBus"/>.
    /// </summary>
    ...
    public static Land Create(Player owner, ReplacementBus? replacements)
    {
        ...
        // CR 301.1 / 305.1 — Razortide Bridge is an Artifact Land. The base
        ...
        // ----------------------------------------------------------------
        // {T}: Add {W} or {U}. CR 605.1 — two mana abilities (no stack),
