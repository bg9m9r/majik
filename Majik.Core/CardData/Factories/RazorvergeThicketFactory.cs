...
/// <summary>
/// Named-card factory for Razorverge Thicket (Mirrodin Besieged) — the G/W
...
/// <c>Majik.Core/CardData/Cards/razorverge-thicket.json</c> and materialized
...
public static class RazorvergeThicketFactory
{
    ...
    /// <summary>
    /// Construct Razorverge Thicket owned and controlled by
    ...
    /// <summary>
    /// Construct Razorverge Thicket with an optional <see cref="ReplacementBus"/>
