...
/// <summary>
/// Named-card factory for Rugged Highlands (Khans of Tarkir "life-gain dual
/// land", a.k.a. the gain-land cycle). Red/green member — sibling of the
...
/// {R}/{G} (CR 605.1 — mana abilities don't use the stack).
/// </para>
///
/// <para>
...
/// declaratively in <c>Majik.Core/CardData/Cards/rugged-highlands.json</c> and
...
{
    public const string Slug = "rugged-highlands";
    ...
    /// <summary>Construct Rugged Highlands with optional replacement-bus
