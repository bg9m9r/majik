...
/// <summary>
/// Named-card factory for Rupture Spire (Conflux). Oracle text (verified
/// against Scryfall):
...
///
/// <para>
/// Functionally identical to Transguild Promenade — an any-colour land with
/// an enters-tapped restriction and an ETB "pay {1} or sacrifice" tax. Built
/// entirely from existing engine primitives, mirroring three cited
/// analogues:
/// </para>
/// <list type="bullet">
...
/// declaratively in <c>Majik.Core/CardData/Cards/rupture-spire.json</c> and
...
/// </summary>
[CardName("Rupture Spire")]
public static class RuptureSpireFactory
{
    public const string CardName = "Rupture Spire";
    public const string Slug = "rupture-spire";
    ...
    /// <summary>
    /// Construct Rupture Spire owned and controlled by <paramref name="owner"/>
    ...
    /// <summary>
    /// Construct Rupture Spire with optional runtime wiring.
    /// </summary>
