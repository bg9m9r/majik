...
/// <summary>
/// Named-card factory for Rustvale Bridge (March of the Machine: The
/// Aftermath — the RW member of the artifact "Bridge" tapland cycle, the
/// direct sibling of <see cref="RazortideBridgeFactory"/> (WU) and
/// <see cref="MistvaultBridgeFactory"/> (UB)).
///
...
/// - <b>{T}: Add {R} or {W}</b> (CR 605.1 — mana abilities don't use the
///   stack) — two vanilla <see cref="ManaAbility"/> instances, one per
///   produced colour.
/// </summary>
[CardName("Rustvale Bridge")]
public static class RustvaleBridgeFactory
{
    public const string CardName = "Rustvale Bridge";

    /// <summary>
    /// Construct Rustvale Bridge owned and controlled by
    ...
    /// <summary>
    /// Construct Rustvale Bridge with an optional <see cref="ReplacementBus"/>.
    /// </summary>
    ...
    public static Land Create(Player owner, ReplacementBus? replacements)
    {
        ...
        // CR 301.1 / 305.1 — Rustvale Bridge is an Artifact Land. The base
        ...
        // ----------------------------------------------------------------
        // {T}: Add {R} or {W}. CR 605.1 — two mana abilities (no stack),
