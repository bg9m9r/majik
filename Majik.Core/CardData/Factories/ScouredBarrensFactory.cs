...
/// <summary>
/// Named-card factory for Scoured Barrens (Khans of Tarkir "life-gain dual
/// land", a.k.a. the Refuge / gain-land cycle). White/black member — sibling
/// of the white/blue Tranquil Cove and the black/red Bloodfell Caves. Oracle
...
/// {W}/{B} (CR 605.1 — mana abilities don't use the stack).
/// </para>
///
/// <para>
...
/// declaratively in <c>Majik.Core/CardData/Cards/scoured-barrens.json</c> and
...
{
    public const string Slug = "scoured-barrens";
    ...
    /// <summary>Construct Scoured Barrens with optional replacement-bus
