...
/// <summary>
/// Named-card factory for Seachrome Coast (Scars of Mirrodin) — the W/U
...
/// <c>Majik.Core/CardData/Cards/seachrome-coast.json</c> and materialized
...
/// isolation (same shape as <see cref="CheckLandCycleFactory"/>):
...
public static class SeachromeCoastFactory
{
    ...
    /// <summary>
    /// Construct Seachrome Coast owned and controlled by
    ...
    /// <summary>
    /// Construct Seachrome Coast with an optional <see cref="ReplacementBus"/>
