...
/// <summary>
/// Named-card factory for Sejiri Refuge (Worldwake "Refuge" gain-life tapland
/// cycle). White/blue member — same oracle shape as Akoum Refuge, only the two
/// mana colours differ. Oracle text (verified against Scryfall):
...
/// (CR 119.3), and two single-colour mana abilities {W}/{U} (CR 605.1 —
...
/// declaratively in <c>Majik.Core/CardData/Cards/sejiri-refuge.json</c> and
...
{
    public const string Slug = "sejiri-refuge";
    ...
    /// <summary>Construct Sejiri Refuge with optional replacement-bus wiring so
