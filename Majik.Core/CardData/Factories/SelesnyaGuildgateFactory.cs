...
///
/// <para>
/// Mirrors the other Guildgate factories (e.g. <see cref="IzzetGuildgateFactory"/>):
/// the Land shell — the <c>Gate</c> subtype (CR 205.3m / CR 702 gate cards
/// carry the Gate land subtype) plus the two mana abilities {G}/{W}
/// (CR 605.1 — mana abilities don't use the stack) — is declared
/// declaratively in <c>Majik.Core/CardData/Cards/selesnya-guildgate.json</c>
...
public static class SelesnyaGuildgateFactory
{
    ...
    /// <summary>Construct Selesnya Guildgate with optional replacement-bus
