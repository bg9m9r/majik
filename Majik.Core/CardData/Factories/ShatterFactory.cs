...
/// same ability-side <c>destroy_target</c> verb Boseiju uses, here reused on the
/// instant cast path. The "artifact only" restriction is enforced both at gather
/// time and (CR 608.2b) at resolution via the shared
/// <see cref="TargetFilters"/> predicate, so a creature / enchantment passed as a
/// raw target fizzles cleanly. Indestructible (CR 702.12) / regeneration
