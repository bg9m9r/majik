...
/// <summary>
/// Named-card factory for Shattered Sanctum (Innistrad: Crimson Vow
/// slowland cycle).
///
/// W/B slowland. Oracle text:
///   "This land enters tapped unless you control two or more other lands.
///    {T}: Add {W} or {B}."
///
/// Thin wrapper that loads
/// <c>Majik.Core/CardData/Cards/shattered-sanctum.json</c> and lets
...
/// layer in the production path. Same slowland cycle as Deserted Beach,
...
public static class ShatteredSanctumFactory
{
    ...
    /// <summary>
    /// Construct Shattered Sanctum owned and controlled by <paramref name="owner"/>.
    /// </summary>
