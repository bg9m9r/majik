...
/// <summary>
/// Named-card factory for Shimmerdrift Vale (Kaldheim — Snow Land). Oracle text
...
///
/// <para>
/// The snow Vivid-style choose-a-colour tapland: the unconditional
/// enters-tapped half of <see cref="CinderBarrensFactory"/> combined with the
/// "as this enters, choose a color" up-front-resolution posture of
/// <see cref="TempleOfTheDragonQueenFactory"/> (CR 614.12 / 614.10). The Snow
/// supertype + bare Land shell are declared in
/// <c>Majik.Core/CardData/Cards/shimmerdrift-vale.json</c> and materialized via
/// <see cref="CardDefinitionFactory"/>. The {T} mana ability's colour is not
/// known until the choose-a-colour decision is made, so — like Temple — it is
/// wired in the factory once the chosen colour is supplied, not declared in JSON.
/// </para>
///
/// <para>
...
/// </para>
/// </summary>
[CardName("Shimmerdrift Vale")]
public static class ShimmerdriftValeFactory
{
    public const string Slug = "shimmerdrift-vale";

    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource(Slug);

    /// <summary>Construct Shimmerdrift Vale owned and controlled by
    ...
    /// <summary>
    /// Construct a fully-wired Shimmerdrift Vale.
    /// </summary>
    /// <param name="owner">Card owner / initial controller.</param>
    /// <param name="chosenColor">The colour chosen "as this land enters"
    ...
    private static ManaCost ManaCostForColor(ManaColor color) => color switch
    {
        ...
        _ => throw new ArgumentOutOfRangeException(
            nameof(color), color,
            "Shimmerdrift Vale's chosen color must be one of W/U/B/R/G (CR 105.1)."),
    };
}
