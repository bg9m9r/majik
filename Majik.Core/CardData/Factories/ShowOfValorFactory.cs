...
/// <summary>
/// Named-card factory for Show of Valor (Jumpstart 2022, {1}{W}).
///
/// Instant. Oracle text:
///   "Target creature gets +2/+4 until end of turn."
///
/// ## Implemented (v1)
/// - Instant card with printed mana cost {1}{W}.
/// - <see cref="BuildDefinition"/> wires the resolve effect:
///   1..1 "target creature" <see cref="TargetRequest"/>. On resolve:
///   register a <see cref="PumpUntilEndOfTurnEffect"/>(+2, +4) on the
...
///
/// Mirrors <see cref="GiantGrowthFactory"/> with an asymmetric +2/+4 pump
/// at {1}{W} instead of +3/+3 at {G}.
/// </summary>
[CardName("Show of Valor")]
public static class ShowOfValorFactory
{
    public const string CardName = "Show of Valor";
    public const string PrintedManaCost = "{1}{W}";

    /// <summary>Layer 7c +P magnitude (CR 613.1g).</summary>
    public const int PumpPower = 2;

    /// <summary>Layer 7c +T magnitude (CR 613.1g).</summary>
    ...
    /// <summary>
    /// Build the "target creature gets +2/+4 until end of turn"
    ...
    /// valid, registers a <see cref="PumpUntilEndOfTurnEffect"/>(+2, +4)
    ...
    public static SpellDefinition BuildDefinition() =>
        new(
            ...
            EffectFactory: p =>
            {
                ...
                {
                    new Effect(
                        "Show of Valor — target creature gets +2/+4 until end of turn",
                        () => Resolve(raw)),
                };
            });
