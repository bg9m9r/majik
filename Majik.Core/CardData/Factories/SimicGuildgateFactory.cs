...
/// <summary>
/// Named-card factory for Simic Guildgate (Gatecrash / Guilds of Ravnica
/// gate cycle). Oracle text:
///   "This land enters tapped.
///    {T}: Add {G} or {U}."
///
/// <para>
/// Mirrors <see cref="IzzetGuildgateFactory"/>: the Land shell — the
/// <c>Gate</c> subtype (CR 205.3m) plus the two mana abilities {G}/{U}
/// (CR 605.1 — mana abilities don't use the stack) — is declared
/// declaratively in <c>Majik.Core/CardData/Cards/simic-guildgate.json</c>
/// and materialized via <see cref="CardDefinitionFactory"/>. There is no
/// cycling clause (unlike the triome cycle).
/// </para>
///
/// <para>
...
public static class SimicGuildgateFactory
{
    ...
    /// <summary>Construct Simic Guildgate with optional replacement-bus
