...
/// <summary>
/// Named-card factory for Smoldering Marsh (Battle for Zendikar) — a member of
/// the "battle land" / "tango land" nonbasic dual cycle. Oracle text:
///   "({T}: Add {B} or {R}.)
///    This land enters tapped unless you control two or more basic lands."
///
/// <para>
/// The Land shell — both printed land subtypes (Swamp / Mountain) plus the
/// two mana abilities {B}/{R} (CR 605.1 — mana abilities don't use the
/// stack) — is declared declaratively in
/// <c>Majik.Core/CardData/Cards/smoldering-marsh.json</c> and materialized via
...
public static class SmolderingMarshFactory
{
    ...
    /// <summary>Construct Smoldering Marsh owned and controlled by
    /// <paramref name="owner"/> (shape-only path — no ETB-tapped
    /// replacement wired).</summary>
    public static Land Create(Player owner) => Create(owner, replacements: null);

    /// <summary>Construct Smoldering Marsh with an optional
