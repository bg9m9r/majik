...
/// <summary>
/// Named-card factory for Spirebluff Canal (Kaladesh) — the U/R member of the
...
/// <c>Majik.Core/CardData/Cards/spirebluff-canal.json</c> and materialized
...
public static class SpirebluffCanalFactory
{
    ...
    /// <summary>
    /// Construct Spirebluff Canal owned and controlled by
    ...
    /// <summary>
    /// Construct Spirebluff Canal with an optional <see cref="ReplacementBus"/>
