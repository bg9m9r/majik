...
public static class StonecoilSerpentFactory
{
        ...
        IEventBus? eventBus)
    {
        ...
        // abilities — the keyword riders + ETB trigger are layered below.
        ...
        // trigger effect: read PendingCastX (stamped by SpellCastFlow right
        // after ChooseXAsync), apply that many +1/+1 counters via
        ...
        // matching the printed behaviour. Same pattern as
        // HangarbackWalkerFactory's ETB-counter trigger.
        // ----------------------------------------------------------------
