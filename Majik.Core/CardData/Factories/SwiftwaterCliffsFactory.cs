...
/// <summary>
/// Named-card factory for Swiftwater Cliffs (Khans of Tarkir "life-gain dual
/// land", a.k.a. the gain-land cycle). Blue/red member — sibling of the
...
/// {U}/{R} (CR 605.1 — mana abilities don't use the stack).
/// </para>
///
/// <para>
...
/// declaratively in <c>Majik.Core/CardData/Cards/swiftwater-cliffs.json</c> and
...
{
    public const string Slug = "swiftwater-cliffs";
    ...
    /// <summary>Construct Swiftwater Cliffs with optional replacement-bus
