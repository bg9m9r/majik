...
/// <summary>
/// Named-card factory for TCRI Building (a blue/red gain-life tapland, same
/// oracle shape as the Zendikar "Refuge" cycle). Oracle text (verified against
/// Scryfall):
...
/// (CR 119.3), and two single-colour mana abilities {U}/{R} (CR 605.1 —
/// mana abilities don't use the stack). Only the colours differ from
/// <see cref="AkoumRefugeFactory"/> (B/R).
/// </para>
///
/// <para>
...
/// declaratively in <c>Majik.Core/CardData/Cards/tcri-building.json</c> and
...
/// </para>
/// </summary>
[CardName("TCRI Building")]
public static class TcriBuildingFactory
{
    public const string Slug = "tcri-building";

    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource(Slug);

    /// <summary>Construct TCRI Building owned and controlled by
    ...
    /// <summary>Construct TCRI Building with optional replacement-bus wiring so
