...
///    {T}: Add {R} or {G}."
///
/// Scryfall type line: Land (no basic supertype, no subtype). An R/G member of
/// the Theros "scry land" cycle — same oracle shape as Temple of Malice /
/// Temple of Triumph etc.; only the produced colours differ ({R}/{G} here).
///
...
/// definition (<c>temple-of-abandon.json</c>) via
...
{
    public const string CardName = "Temple of Abandon";

    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource("temple-of-abandon");

    /// <summary>
    /// Construct Temple of Abandon owned and controlled by
