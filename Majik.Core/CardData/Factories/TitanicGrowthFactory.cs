...
/// <summary>
/// Named-card factory for Titanic Growth (Magic 2014, {1}{G}).
///
/// Instant. Oracle text:
///   "Target creature gets +4/+4 until end of turn."
///
/// ## Implemented (v1)
/// - Instant card with printed mana cost {1}{G}.
...
///
/// Mirrors <see cref="GiantGrowthFactory"/> at one more mana for one
/// more +1/+1.
/// </summary>
[CardName("Titanic Growth")]
public static class TitanicGrowthFactory
{
    public const string CardName = "Titanic Growth";
