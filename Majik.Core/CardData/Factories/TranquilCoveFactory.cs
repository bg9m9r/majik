...
/// <summary>
/// Named-card factory for Tranquil Cove (Khans of Tarkir "life-gain dual
/// land", the W/U member of the Refuge gain-land cycle). Oracle text
...
/// declaratively in <c>Majik.Core/CardData/Cards/tranquil-cove.json</c> and
...
{
    public const string Slug = "tranquil-cove";
    ...
    /// <summary>Construct Tranquil Cove with optional replacement-bus wiring so
