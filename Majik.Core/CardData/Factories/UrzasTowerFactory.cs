...
/// <summary>
/// Named-card factory for Urza's Tower (Antiquities — Urza Tron cycle).
///
/// Land — Urza's Tower. Oracle text:
...
{
    /// <summary>
    /// Construct Urza's Tower owned and controlled by <paramref name="owner"/>.
    /// </summary>
    public static Land Create(Player owner)
    {
        ...
        var land = new Land(
            "Urza's Tower",
            supertypes: null,
            subtypes: new[] { CardSubtype.Urzas, CardSubtype.Tower });
        land.SetOwner(owner);
