...
/// Vastwood Fortification // Vastwood Thicket (Modern Horizons 3).
///
/// Land. Oracle text (back, verified against Scryfall):
///   "This land enters tapped."
///   "{T}: Add {G}."
///
/// Front face — <see cref="VastwoodFortificationFactory"/> (Instant {G} —
/// "Put a +1/+1 counter on target creature.").
///
/// ## MDFC infra
/// See <see cref="VastwoodFortificationFactory"/>'s class doc for the
...
/// <c>"Vastwood Thicket"</c> and lands here. The card is constructed with its
...
///   {T}: Add {G} tapland shape; this factory directly mirrors it.
/// </summary>
[CardName("Vastwood Thicket")]
public static class VastwoodThicketFactory
{
    public const string CardName = "Vastwood Thicket";
    public const string FrontName = "Vastwood Fortification";

    /// <summary>
    /// Construct Vastwood Thicket without a <see cref="ReplacementBus"/>.
    /// The ETB-tapped replacement is omitted; the {T}: Add {G} mana ability
    /// is still wired. Suitable for shape / dispatcher tests.
    /// </summary>
    public static Land Create(Player owner) => Create(owner, replacements: null);

    /// <summary>
    /// Construct Vastwood Thicket with an optional <see cref="ReplacementBus"/>
    ...
    public static Land Create(Player owner, ReplacementBus? replacements)
    {
        ...
        // Vastwood Thicket is a vanilla nonbasic land — no basic land
        ...
        // back face (Vastwood Thicket is the back face that actually exists
        // on the battlefield).
