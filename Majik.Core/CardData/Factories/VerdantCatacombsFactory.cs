...
/// <summary>
/// Named-card factory for Verdant Catacombs (Zendikar / Modern Horizons / reprints).
///
/// Land. Oracle text:
///   "{T}, Pay 1 life, Sacrifice Verdant Catacombs: Search your library for
///    a Swamp or Forest card and put it onto the battlefield. Then shuffle
///    your library."
///
/// ## Implemented (v1)
...
///   Swamp or Forest, put onto the battlefield untapped.
...
public static class VerdantCatacombsFactory
{
    public const string CardName = "Verdant Catacombs";
    ...
    public static Land Create(Player owner)
    {
        ...
        var fetchEffect = new Effect(
            $"{CardName}: search library for Swamp or Forest, put onto battlefield",
            () =>
            {
