...
/// Sundering Eruption // Volcanic Fissure (Innistrad: Reawakening).
///
...
///   "{T}: Add {R}."
///
/// Front face — <see cref="SunderingEruptionFactory"/> (Sorcery {2}{R}
...
///
/// ## MDFC infra
/// See <see cref="SunderingEruptionFactory"/>'s class doc for the
...
/// resolves the back-face name <c>"Volcanic Fissure"</c> and lands here.
...
/// - <see cref="FellMireFactory"/> — red analogue ({T}: Add {B}) within the
///   same MDFC family.
/// </summary>
[CardName("Volcanic Fissure")]
public static class VolcanicFissureFactory
{
    public const string CardName = "Volcanic Fissure";
    public const string FrontName = "Sundering Eruption";

    /// <summary>
    /// Construct Volcanic Fissure without a <see cref="ReplacementBus"/>.
    /// The ETB-tapped predicate is omitted; the {T}: Add {R} mana ability
    /// is still wired. Suitable for card-shape / dispatcher tests.
    /// </summary>
    public static Land Create(Player owner) => Create(owner, replacements: null);

    /// <summary>
    /// Construct Volcanic Fissure with an optional <see cref="ReplacementBus"/>
    /// for full ETB wiring.
    /// </summary>
    ...
    public static Land Create(Player owner, ReplacementBus? replacements)
    {
        ...
        // Volcanic Fissure is a vanilla nonbasic land — no basic land
        ...
        // back face (Volcanic Fissure is the back face that actually exists
    ...
    private static bool TryPayThreeLifeOrEnterTapped(Player controller, ICard self)
    {
        ...
        try
        {
            wantsToPay = agent.ChooseYesNoAsync(
                question: "Pay 3 life so Volcanic Fissure enters untapped?",
