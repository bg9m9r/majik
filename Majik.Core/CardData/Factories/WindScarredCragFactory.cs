...
/// <summary>
/// Named-card factory for Wind-Scarred Crag (Khans of Tarkir "life-gain dual
/// land", a.k.a. the gain-land cycle). Red/white member — sibling of the
/// black/red Bloodfell Caves. Oracle text (verified against Scryfall):
...
/// {R}/{W} (CR 605.1 — mana abilities don't use the stack).
/// </para>
///
/// <para>
...
/// declaratively in <c>Majik.Core/CardData/Cards/wind-scarred-crag.json</c> and
...
{
    public const string Slug = "wind-scarred-crag";
    ...
    /// <summary>Construct Wind-Scarred Crag with optional replacement-bus
