...
/// <summary>
/// Named-card factory for Zagoth Triome (Ikoria: Lair of Behemoths) — the
/// Swamp Forest Island triland ("Triome") cycle. Oracle text:
///   "({T}: Add {B}, {G}, or {U}.)
///    This land enters tapped.
///    Cycling {3} ({3}, Discard this card: Draw a card.)"
///
/// <para>
/// The Land shell — all three printed land subtypes (Swamp / Forest /
/// Island) plus the three mana abilities {B}/{G}/{U} (CR 605.1 — mana
/// abilities don't use the stack) — is declared declaratively in
/// <c>Majik.Core/CardData/Cards/zagoth-triome.json</c> and materialized via
...
/// </para>
/// </summary>
[CardName("Zagoth Triome")]
public static class ZagothTriomeFactory
{
    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource("zagoth-triome");

    /// <summary>Construct Zagoth Triome owned and controlled by
    ...
    /// <summary>Construct Zagoth Triome with optional bus wiring so the
