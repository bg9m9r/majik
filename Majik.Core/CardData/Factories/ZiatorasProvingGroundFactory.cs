...
/// <summary>
/// Named-card factory for Ziatora's Proving Ground (Streets of New Capenna /
/// reprints).
///
/// B/R/G triome (a "Triome" is the three-colour tapland cycle). Oracle text:
///   "({T}: Add {B}, {R}, or {G}.)
...
///   same posture as <see cref="IndathaTriomeFactory"/>.
...
/// same posture as <see cref="IndathaTriomeFactory"/> and the other
/// JSON-loaded tapland wrappers — and is supplied in production by
/// <c>EntersTappedBinder</c>.
/// </summary>
[CardName("Ziatora's Proving Ground")]
public static class ZiatorasProvingGroundFactory
{
    private static readonly CardDefinition Definition =
        CardDefinitionLoader.FromEmbeddedResource("ziatoras-proving-ground");

    /// <summary>Construct Ziatora's Proving Ground owned and controlled by
    ...
    /// <summary>Construct Ziatora's Proving Ground with optional bus wiring
    /// for the cycling resolve publication (CR 702.32d).</summary>
