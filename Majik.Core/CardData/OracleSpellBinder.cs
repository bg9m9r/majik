...
public static class OracleSpellBinder
{
    ...
    private static ISpellTemplate[] BuildTemplateList() =>
        new ISpellTemplate[]
        {
            ...
            new SpellTemplates.Templates.Copy.CopyTargetSpellTemplate(),
            ...
            new SpellTemplates.Templates.Damage.ExsanguinateDrainTemplate(),
            ...
            new SpellTemplates.Templates.Damage.DamageEachPlayerTemplate(),
            new SpellTemplates.Templates.Damage.DamageDividedTemplate(),
            new SpellTemplates.Templates.Damage.DamageEachOfNTargetsTemplate(),
            ...
            new SpellTemplates.Templates.Library.StargazeTemplate(),
            ...
            new SpellTemplates.Templates.Bespoke.GrappleWithThePastPatternTemplate(),
            ...
            new SpellTemplates.Templates.Bespoke.AetherizeTemplate(),
